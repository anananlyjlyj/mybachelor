...
NotebookDataLength[     78550,       1570]
NotebookOptionsPosition[     51904,        999]
NotebookOutlinePosition[     77916,       1554]
CellTagsIndexPosition[     77843,       1549]
WindowTitle->Complex Spherical Harmonics
WindowFrame->Normal*)
...
Cell["Complex Spherical Harmonics", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`L$$ = 0, $CellContext`m$$ = 0, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`L$$], 0, 
       Style["l", Italic]}, 0, 4, 1}, {{
       Hold[$CellContext`m$$], 0, 
       Style["m", Italic]}, 
      Dynamic[
       Range[-$CellContext`L$$, $CellContext`L$$]]}}, Typeset`size$$ = {
    600., {101., 105.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`L$755230$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`L$$ = 0, $CellContext`m$$ = 0}, 
      "ControllerVariables" :> {
        Hold[$CellContext`L$$, $CellContext`L$755230$$, 0]}, 
      "OtherVariables" :> {
...
$CellContext`L$$]; 
       If[$CellContext`m$$ < -$CellContext`L$$, $CellContext`m$$ = \
-$CellContext`L$$]; GraphicsRow[{
          SphericalPlot3D[
           Abs[
            
            SphericalHarmonicY[$CellContext`L$$, $CellContext`m$$, \
$CellContext`\[CurlyTheta], $CellContext`\[Phi]]], \
{$CellContext`\[CurlyTheta], 0, Pi}, {$CellContext`\[Phi], -Pi, Pi}, 
           ColorFunction -> 
           Function[{$CellContext`x$, $CellContext`y$, $CellContext`z$, \
$CellContext`t$, $CellContext`p$, $CellContext`r$}, 
             Hue[Arg[
                
                SphericalHarmonicY[$CellContext`L$$, $CellContext`m$$, \
$CellContext`t$, $CellContext`p$]]/(2. Pi)]], ColorFunctionScaling -> False, 
           PerformanceGoal -> "Quality", Axes -> True, TicksStyle -> 
           Directive[Gray], AxesLabel -> $CellContext`lab1, SphericalRegion -> 
           True, Mesh -> False, Boxed -> True, PlotLabel -> Style[
             ...
             With[{$CellContext`L = $CellContext`L$$, $CellContext`m = 
              ...
              TraditionalForm[
               HoldForm[
                ...
                SphericalHarmonicY[$CellContext`L, $CellContext`m, "\[Theta]",
                  "\[Phi]"]]]], 14], PlotRange -> All], 
          SphericalPlot3D[
           Abs[
            Re[
             
             SphericalHarmonicY[$CellContext`L$$, $CellContext`m$$, \
$CellContext`\[CurlyTheta], $CellContext`\[Phi]]]], {$CellContext`\
\[CurlyTheta], 0, Pi}, {$CellContext`\[Phi], -Pi, Pi}, ColorFunction -> 
           Function[{$CellContext`x$, $CellContext`y$, $CellContext`z$, \
$CellContext`t$, $CellContext`p$, $CellContext`r$}, 
             Hue[Arg[
                Re[
...
$CellContext`t$, $CellContext`p$]]]/(2. Pi)]], ColorFunctionScaling -> False, 
           PerformanceGoal -> "Quality", Axes -> True, TicksStyle -> 
           Directive[Gray], AxesLabel -> $CellContext`lab1, Boxed -> True, 
           BoxStyle -> Directive[
             Lighter[Gray]], Mesh -> False, PlotLabel -> Style[
...
$CellContext`t$, $CellContext`p$]]]/(2. Pi)]], ColorFunctionScaling -> False, 
           PerformanceGoal -> "Quality", Axes -> True, TicksStyle -> 
           Directive[Gray], Boxed -> True, BoxStyle -> Directive[
             Lighter[Gray]], Mesh -> False, AxesLabel -> $CellContext`lab1, 
           PlotLabel -> Style[
              ...
              Row[{"Im ", 
                TraditionalForm[
                 HoldForm[
                  ...
                  SphericalHarmonicY[$CellContext`L, $CellContext`m, 
                   "\[Theta]", "\[Phi]"]]]}]], 14], PlotRange -> All]}, 
         ImageSize -> 600]), "Specifications" :> {{{$CellContext`L$$, 0, 
          Style["l", Italic]}, 0, 4, 1}, {{$CellContext`m$$, 0, 
          Style["m", Italic]}, 
         Dynamic[
          Range[-$CellContext`L$$, $CellContext`L$$]]}}, 
      "Options" :> {
       TrackedSymbols :> {$CellContext`L$$, $CellContext`m$$}, ControlType -> 
        SetterBar}, "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{645., {156., 161.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`lab1 = {
          Text[
           Style["x", Italic]], 
          Text[
           Style["y", Italic]], 
          Text[
           Style["z", Italic]]}, Attributes[PlotRange] = {ReadProtected}}; 
      Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{$CellContext`lab1 = {
            Text[
             Style["x", Italic]], 
            Text[
             Style["y", Italic]], 
            Text[
             Style["z", Italic]]}; Null}]]; Typeset`initDone$$ = True),
...
Cell[TextData[{
 "Spherical harmonic functions arise for central force problems in quantum \
mechanics as the angular part of the Schr\[ODoubleDot]dinger equation in \
spherical polar coordinates. They are given by ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{
      ...
      RowBox[{
       ...
       FractionBox[
        RowBox[{
         RowBox[{"(", 
          RowBox[{
           RowBox[{"\[ScriptL]", "-"}], "\[VerticalSeparator]", "m", 
           "\[VerticalSeparator]"}], ")"}], "!"}], 
        RowBox[{
         RowBox[{"(", 
          RowBox[{
 ...
 Cell[BoxData[
  FormBox[
   SubsuperscriptBox["P", "\[ScriptL]", "m"], TraditionalForm]], "InlineMath"],
 ...
 " are the orbital and magnetic quantum numbers, respectively. The allowed \
values of the quantum numbers, which follow from the boundary conditions of \
the problem, are ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"\[ScriptL]", "=", "0"}], ",", "1", ",", "2", ",", "...", " ", 
    ",", "\[Infinity]", ",", " ", 
    RowBox[{"m", "=", "0"}], ",", 
    RowBox[{"\[PlusMinus]", "1"}], ",", 
    RowBox[{"\[PlusMinus]", "2"}], ",", "...", ",", 
 ...
 Cell[BoxData[
  ...
  "InlineMath"],
 " is shown on the left, where the shape is its modulus and the coloring \
corresponds to its argument, the range 0 to ",
 Cell[BoxData[
  FormBox[
   RowBox[{"2", "\[Pi]"}], TraditionalForm]], "InlineMath"],
 " corresponding to colors from red to magenta. The center and right graphics \
show the corresponding real and imaginary parts."
}], "ManipulateCaption",
 CellID->2121543024],
...
Cell[TextData[{
 "S. M. Blinder, ",
 StyleBox["Introduction to Quantum Mechanics: In Chemistry, Materials Science \
and Biology, ",
  FontSlant->"Italic"],
...
ComplexSphericalHarmonics&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/ComplexSphericalHarmonics/\
ComplexSphericalHarmonics-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Complex Spherical Harmonics",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ComplexSphericalHarmonics/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ComplexSphericalHarmonics/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/ComplexSphericalHarmonics/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ComplexSphericalHarmonics/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ComplexSphericalHarmonics/"]
...
CellTagsIndex->{
 "Copyright"->{
  Cell[51082, 974, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"Copyright", 77752, 1543}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34973, 592, 6332, 141, 70, "Output",
 CellID->100736627],
Cell[41308, 735, 2686, 73, 70, "ManipulateCaption",
 CellID->2121543024],
Cell[43997, 810, 33, 0, 70, "DetailsSection"],
Cell[44033, 812, 244, 7, 70, "DetailNotes",
 CellID->738043814],
Cell[44280, 821, 44, 0, 70, "RelatedLinksSection"],
Cell[44327, 823, 482, 14, 70, "RelatedLinks",
 CellID->1817429136],
Cell[44812, 839, 4814, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[49629, 930, 45, 0, 70, "CitationSection"],
Cell[49677, 932, 815, 20, 70, "Citations"],
Cell[50495, 954, 584, 18, 70, "Author"],
Cell[51082, 974, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature PTUMw8PH12VbiwQ8LbfS#uFV *)
