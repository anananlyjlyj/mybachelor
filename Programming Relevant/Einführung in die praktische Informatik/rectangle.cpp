...
void testRectangle()
{
    ...
    assert(r3.transpose(Point(1.0, 1.0)).p1() == Point(4.0, 5.0));
    // g)Tests
    ...
    assert(rectangle_union(r4, r3) == nothing);
    assert(rectangle_intersection(r4, r3) == nothing);
    assert(rectangle_intersection(r1, r3) == nothing);
